...
#    error \
        "The header file 'objectmovemapextention.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len)                                          \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(                   \
        len,                                                                   \
        qptrdiff(                                                              \
            offsetof(qt_meta_stringdata_qmapcontrol__ObjectMoveMapExtention_t, \
                     stringdata0)                                              \
            + ofs - idx * sizeof(QByteArrayData)))
static const qt_meta_stringdata_qmapcontrol__ObjectMoveMapExtention_t
    qt_meta_stringdata_qmapcontrol__ObjectMoveMapExtention = {
        {
...
static const uint qt_meta_data_qmapcontrol__ObjectMoveMapExtention[] = {
    ...
    1, 1, 49, 2, 0x06 /* Public */, 5, 1, 52, 2, 0x06 /* Public */,

    // slots: name, argc, parameters, tag, flags
    6, 0, 55, 2, 0x0a /* Public */, 7, 1, 56, 2, 0x0a /* Public */, 9, 2, 59, 2,
    0x08 /* Private */, 13, 2, 64, 2, 0x08 /* Private */, 14, 2, 69, 2,
    0x08 /* Private */,
    ...
    // slots: parameters
    QMetaType::Void, QMetaType::Void, 0x80000000 | 8, 2, QMetaType::Void,
    0x80000000 | 10, QMetaType::QPointF, 11, 12, QMetaType::Void,
    0x80000000 | 10, QMetaType::QPointF, 11, 12, QMetaType::Void,
    0x80000000 | 10, QMetaType::QPointF, 11, 12,

    0  // eod
};

void qmapcontrol::ObjectMoveMapExtention::qt_static_metacall(
    QObject* _o, QMetaObject::Call _c, int _id, void** _a)
{
    if (_c == QMetaObject::InvokeMetaMethod)
    {
        ...
        {
            case 0:
                _t->objectMoved((*reinterpret_cast<Geometry*(*)>(_a[1])));
                break;
            case 1:
                _t->objectSelected((*reinterpret_cast<Geometry*(*)>(_a[1])));
                break;
            case 2:
                _t->start();
                break;
    ...
    else if (_c == QMetaObject::IndexOfMethod)
    {
        int* result = reinterpret_cast<int*>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t*>(_a[1])
                == static_cast<_t>(&ObjectMoveMapExtention::objectMoved))
            {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ObjectMoveMapExtention::*)(Geometry*);
            if (*reinterpret_cast<_t*>(_a[1])
                == static_cast<_t>(&ObjectMoveMapExtention::objectSelected))
            {
                *result = 1;
                return;
            }
...
QT_INIT_METAOBJECT const QMetaObject
    qmapcontrol::ObjectMoveMapExtention::staticMetaObject = {
        {&CheckableMapExtention::staticMetaObject,
         qt_meta_stringdata_qmapcontrol__ObjectMoveMapExtention.data,
         qt_meta_data_qmapcontrol__ObjectMoveMapExtention, qt_static_metacall,
         nullptr, nullptr}};
...
void* qmapcontrol::ObjectMoveMapExtention::qt_metacast(const char* _clname)
{
    ...
    if (!strcmp(
            _clname,
            qt_meta_stringdata_qmapcontrol__ObjectMoveMapExtention.stringdata0))
...
int qmapcontrol::ObjectMoveMapExtention::qt_metacall(QMetaObject::Call _c,
                                                     int _id, void** _a)
{
