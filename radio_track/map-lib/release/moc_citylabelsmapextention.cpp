...
#    error \
        "The header file 'citylabelsmapextention.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len)                                          \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(                   \
        len,                                                                   \
        qptrdiff(                                                              \
            offsetof(qt_meta_stringdata_qmapcontrol__CityLabelsMapExtention_t, \
                     stringdata0)                                              \
            + ofs - idx * sizeof(QByteArrayData)))
static const qt_meta_stringdata_qmapcontrol__CityLabelsMapExtention_t
    qt_meta_stringdata_qmapcontrol__CityLabelsMapExtention = {
        {
...
static const uint qt_meta_data_qmapcontrol__CityLabelsMapExtention[] = {
    ...
    1, 1, 29, 2, 0x0a /* Public */, 4, 0, 32, 2, 0x0a /* Public */, 5, 1, 33, 2,
    0x0a /* Public */,
...
void qmapcontrol::CityLabelsMapExtention::qt_static_metacall(
...
QT_INIT_METAOBJECT const QMetaObject
    qmapcontrol::CityLabelsMapExtention::staticMetaObject = {
        {&qmapcontrol::CheckableMapExtention::staticMetaObject,
         qt_meta_stringdata_qmapcontrol__CityLabelsMapExtention.data,
         qt_meta_data_qmapcontrol__CityLabelsMapExtention, qt_static_metacall,
         nullptr, nullptr}};
...
void* qmapcontrol::CityLabelsMapExtention::qt_metacast(const char* _clname)
{
    ...
    if (!strcmp(
            _clname,
            qt_meta_stringdata_qmapcontrol__CityLabelsMapExtention.stringdata0))
        return static_cast<void*>(this);
    return qmapcontrol::CheckableMapExtention::qt_metacast(_clname);
}

int qmapcontrol::CityLabelsMapExtention::qt_metacall(QMetaObject::Call _c,
                                                     int _id, void** _a)
{
