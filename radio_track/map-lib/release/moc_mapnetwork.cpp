...
#define QT_MOC_LITERAL(idx, ofs, len)                                        \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(                 \
        len, qptrdiff(offsetof(qt_meta_stringdata_qmapcontrol__MapNetwork_t, \
                               stringdata0)                                  \
                      + ofs - idx * sizeof(QByteArrayData)))
static const qt_meta_stringdata_qmapcontrol__MapNetwork_t
    qt_meta_stringdata_qmapcontrol__MapNetwork = {
        {
...
static const uint qt_meta_data_qmapcontrol__MapNetwork[] = {
    ...
    8, 6, 45, 2, 0x0a /* Public */, 10, 5, 58, 2, 0x0a /* Public */, 11, 0, 69,
    2, 0x08 /* Private */,

    // signals: parameters
    QMetaType::Void, QMetaType::QString, QMetaType::Int, QMetaType::Int,
    QMetaType::Int, QMetaType::Int, 3, 4, 5, 6, 7,

    // slots: parameters
    QMetaType::Void, QMetaType::QString, QMetaType::Int, QMetaType::Int,
    QMetaType::Int, QMetaType::Int, QMetaType::QPixmap, 3, 4, 5, 6, 7, 9,
    QMetaType::Void, QMetaType::QString, QMetaType::Int, QMetaType::Int,
    QMetaType::Int, QMetaType::Int, 3, 4, 5, 6, 7, QMetaType::Void,

    0  // eod
};

void qmapcontrol::MapNetwork::qt_static_metacall(QObject* _o,
                                                 ...
                                                 void** _a)
{
    if (_c == QMetaObject::InvokeMetaMethod)
    {
        ...
        {
            case 0:
                _t->loadImageRequest((*reinterpret_cast<QString(*)>(_a[1])),
                ...
                break;
            case 1:
                _t->tileRecieved((*reinterpret_cast<const QString(*)>(_a[1])),
                                 (*reinterpret_cast<int(*)>(_a[2])),
                                 (*reinterpret_cast<int(*)>(_a[3])),
                                 (*reinterpret_cast<int(*)>(_a[4])),
                                 (*reinterpret_cast<int(*)>(_a[5])),
                                 (*reinterpret_cast<const QPixmap(*)>(_a[6])));
                break;
            case 2:
                _t->tileEmpty((*reinterpret_cast<const QString(*)>(_a[1])),
                              (*reinterpret_cast<int(*)>(_a[2])),
                              (*reinterpret_cast<int(*)>(_a[3])),
                              (*reinterpret_cast<int(*)>(_a[4])),
                              (*reinterpret_cast<int(*)>(_a[5])));
    ...
    else if (_c == QMetaObject::IndexOfMethod)
    {
        int* result = reinterpret_cast<int*>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t*>(_a[1])
                == static_cast<_t>(&MapNetwork::loadImageRequest))
            {
                *result = 0;
                return;
            }
...
QT_INIT_METAOBJECT const QMetaObject qmapcontrol::MapNetwork::staticMetaObject =
    {{&MapLoader::staticMetaObject,
      ...
      qt_meta_data_qmapcontrol__MapNetwork, qt_static_metacall, nullptr,
      nullptr}};
...
void* qmapcontrol::MapNetwork::qt_metacast(const char* _clname)
{
    if (!_clname)
        return nullptr;
    if (!strcmp(_clname,
                qt_meta_stringdata_qmapcontrol__MapNetwork.stringdata0))
        return static_cast<void*>(this);
    return MapLoader::qt_metacast(_clname);
}

int qmapcontrol::MapNetwork::qt_metacall(QMetaObject::Call _c, int _id,
                                         void** _a)
{
...
// SIGNAL 0
void qmapcontrol::MapNetwork::loadImageRequest(QString _t1, int _t2, int _t3,
                                               int _t4, int _t5)
{
    void* _a[] = {nullptr,
