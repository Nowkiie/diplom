...
#    error \
        "The header file 'selectionmapextention.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len)                                         \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(                  \
        len,                                                                  \
        qptrdiff(                                                             \
            offsetof(qt_meta_stringdata_qmapcontrol__SelectionMapExtention_t, \
                     stringdata0)                                             \
            + ofs - idx * sizeof(QByteArrayData)))
static const qt_meta_stringdata_qmapcontrol__SelectionMapExtention_t
    qt_meta_stringdata_qmapcontrol__SelectionMapExtention = {
        {
...
static const uint qt_meta_data_qmapcontrol__SelectionMapExtention[] = {
    ...
    // slots: parameters
    QMetaType::Void, QMetaType::Void, 0x80000000 | 9, 10,

    0  // eod
};

void qmapcontrol::SelectionMapExtention::qt_static_metacall(
    QObject* _o, QMetaObject::Call _c, int _id, void** _a)
{
    if (_c == QMetaObject::InvokeMetaMethod)
    {
        ...
        switch (_id)
        {
            case 0:
                _t->selected(
                    (*reinterpret_cast<QList<Geometry*>(*)>(_a[1])),
                    (*reinterpret_cast<
                        SelectionMapExtention::SelectionModifiers(*)>(_a[2])));
                break;
            case 1:
                _t->start();
                break;
                ...
                switch (*reinterpret_cast<int*>(_a[1]))
                {
                    ...
                    case 0:
                        *reinterpret_cast<int*>(_a[0]) =
                            qRegisterMetaType<QList<Geometry*>>();
                        break;
                }
                break;
            case 2:
    ...
    else if (_c == QMetaObject::IndexOfMethod)
    {
        ...
        {
            using _t = void (SelectionMapExtention::*)(
                QList<Geometry*>, SelectionMapExtention::SelectionModifiers);
            if (*reinterpret_cast<_t*>(_a[1])
                == static_cast<_t>(&SelectionMapExtention::selected))
            {
                *result = 0;
                return;
            }
...
QT_INIT_METAOBJECT const QMetaObject
    qmapcontrol::SelectionMapExtention::staticMetaObject = {
        {&qmapcontrol::CheckableMapExtention::staticMetaObject,
         qt_meta_stringdata_qmapcontrol__SelectionMapExtention.data,
         qt_meta_data_qmapcontrol__SelectionMapExtention, qt_static_metacall,
         nullptr, nullptr}};
...
void* qmapcontrol::SelectionMapExtention::qt_metacast(const char* _clname)
{
    ...
    if (!strcmp(
            _clname,
            qt_meta_stringdata_qmapcontrol__SelectionMapExtention.stringdata0))
...
int qmapcontrol::SelectionMapExtention::qt_metacall(QMetaObject::Call _c,
                                                    int _id, void** _a)
{
...
// SIGNAL 0
void qmapcontrol::SelectionMapExtention::selected(
    QList<Geometry*> _t1, SelectionMapExtention::SelectionModifiers _t2)
{
    void* _a[] = {nullptr,
