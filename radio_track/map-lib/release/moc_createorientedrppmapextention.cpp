...
#    error \
        "The header file 'createorientedrppmapextention.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len)                                            \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(                     \
        ...
        qptrdiff(                                                                \
            offsetof(                                                            \
                qt_meta_stringdata_qmapcontrol__CreateOrientedRppMapExtention_t, \
                stringdata0)                                                     \
            + ofs - idx * sizeof(QByteArrayData)))
static const qt_meta_stringdata_qmapcontrol__CreateOrientedRppMapExtention_t
    qt_meta_stringdata_qmapcontrol__CreateOrientedRppMapExtention = {
        {
...
static const uint qt_meta_data_qmapcontrol__CreateOrientedRppMapExtention[] = {
    ...
    1, 0, 54, 2, 0x0a /* Public */, 3, 1, 55, 2, 0x0a /* Public */, 6, 1, 58, 2,
    0x0a /* Public */, 8, 1, 61, 2, 0x0a /* Public */, 10, 1, 64, 2,
    0x0a /* Public */, 12, 2, 67, 2, 0x08 /* Private */, 16, 2, 72, 2,
    0x08 /* Private */, 17, 2, 77, 2, 0x08 /* Private */,

    // slots: parameters
    QMetaType::Void, QMetaType::Void, 0x80000000 | 4, 5, QMetaType::Void,
    QMetaType::QColor, 7, QMetaType::Void, QMetaType::QString, 9,
    QMetaType::Void, QMetaType::QReal, 11, QMetaType::Void, 0x80000000 | 13,
    QMetaType::QPointF, 14, 15, QMetaType::Void, 0x80000000 | 13,
    QMetaType::QPointF, 14, 15, QMetaType::Void, 0x80000000 | 13,
    QMetaType::QPointF, 14, 15,

    0  // eod
};

void qmapcontrol::CreateOrientedRppMapExtention::qt_static_metacall(
    ...
    if (_c == QMetaObject::InvokeMetaMethod)
    {
        ...
        switch (_id)
        {
            ...
            case 3:
                ...
                break;
            case 4:
                _t->setAzimuth((*reinterpret_cast<qreal(*)>(_a[1])));
                break;
            case 5:
...
QT_INIT_METAOBJECT const QMetaObject
    qmapcontrol::CreateOrientedRppMapExtention::staticMetaObject = {
...
const QMetaObject* qmapcontrol::CreateOrientedRppMapExtention::metaObject()
    const
{
...
void* qmapcontrol::CreateOrientedRppMapExtention::qt_metacast(
    const char* _clname)
{
    if (!_clname)
        return nullptr;
...
int qmapcontrol::CreateOrientedRppMapExtention::qt_metacall(
