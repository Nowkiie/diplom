...
#define QT_MOC_LITERAL(idx, ofs, len)                                   \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(            \
        len, qptrdiff(offsetof(qt_meta_stringdata_qmapcontrol__Layer_t, \
                               stringdata0)                             \
                      + ofs - idx * sizeof(QByteArrayData)))
static const qt_meta_stringdata_qmapcontrol__Layer_t
    qt_meta_stringdata_qmapcontrol__Layer = {
        {
...
static const uint qt_meta_data_qmapcontrol__Layer[] = {
    ...
    1, 1, 49, 2, 0x06 /* Public */, 4, 0, 52, 2, 0x06 /* Public */, 5, 3, 53, 2,
    0x06 /* Public */, 9, 0, 60, 2, 0x06 /* Public */, 10, 0, 61, 2,
    0x06 /* Public */,

    // slots: name, argc, parameters, tag, flags
    11, 1, 62, 2, 0x0a /* Public */, 13, 0, 65, 2, 0x08 /* Private */,

    // signals: parameters
    QMetaType::Void, QMetaType::QRectF, 3, QMetaType::Void, QMetaType::Void,
    QMetaType::Int, QMetaType::Int, QMetaType::Int, 6, 7, 8, QMetaType::Void,
    QMetaType::Void,

    // slots: parameters
    QMetaType::Void, QMetaType::Bool, 12, QMetaType::Void,

    0  // eod
};

void qmapcontrol::Layer::qt_static_metacall(QObject* _o, QMetaObject::Call _c,
                                            int _id, void** _a)
{
    if (_c == QMetaObject::InvokeMetaMethod)
    {
        ...
        switch (_id)
        {
            ...
            case 1:
                ...
                break;
            case 2:
                _t->imageReceivedTile((*reinterpret_cast<int(*)>(_a[1])),
    ...
    else if (_c == QMetaObject::IndexOfMethod)
    {
        int* result = reinterpret_cast<int*>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t*>(_a[1])
                == static_cast<_t>(&Layer::updateRequestRect))
            {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Layer::*)();
            if (*reinterpret_cast<_t*>(_a[1])
                == static_cast<_t>(&Layer::updateRequest))
            {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t*>(_a[1])
                == static_cast<_t>(&Layer::imageReceivedTile))
            {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (Layer::*)();
            if (*reinterpret_cast<_t*>(_a[1])
                == static_cast<_t>(&Layer::loadingFinished))
            {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (Layer::*)();
            if (*reinterpret_cast<_t*>(_a[1])
                == static_cast<_t>(&Layer::imageReceived))
            {
                *result = 4;
                return;
            }
...
QT_INIT_METAOBJECT const QMetaObject qmapcontrol::Layer::staticMetaObject = {
    {&QObject::staticMetaObject, qt_meta_stringdata_qmapcontrol__Layer.data,
     qt_meta_data_qmapcontrol__Layer, qt_static_metacall, nullptr, nullptr}};
