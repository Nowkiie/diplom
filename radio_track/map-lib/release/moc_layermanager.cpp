...
#define QT_MOC_LITERAL(idx, ofs, len)                                          \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(                   \
        len, qptrdiff(offsetof(qt_meta_stringdata_qmapcontrol__LayerManager_t, \
                               stringdata0)                                    \
                      + ofs - idx * sizeof(QByteArrayData)))
static const qt_meta_stringdata_qmapcontrol__LayerManager_t
    qt_meta_stringdata_qmapcontrol__LayerManager = {
        {
...
static const uint qt_meta_data_qmapcontrol__LayerManager[] = {
    ...
    1, 1, 44, 2, 0x0a /* Public */, 4, 0, 47, 2, 0x0a /* Public */, 5, 1, 48, 2,
    0x0a /* Public */, 7, 3, 51, 2, 0x0a /* Public */, 11, 0, 58, 2,
    0x0a /* Public */, 12, 0, 59, 2, 0x0a /* Public */,

    // slots: parameters
    QMetaType::Void, QMetaType::QRectF, 3, QMetaType::Void, QMetaType::Void,
    QMetaType::QSize, 6, QMetaType::Void, QMetaType::Int, QMetaType::Int,
    QMetaType::Int, 8, 9, 10, QMetaType::Void, QMetaType::Void,

    0  // eod
};

void qmapcontrol::LayerManager::qt_static_metacall(QObject* _o,
                                                   QMetaObject::Call _c,
                                                   int _id, void** _a)
{
    if (_c == QMetaObject::InvokeMetaMethod)
    {
        ...
        switch (_id)
        {
            ...
            case 1:
                ...
                break;
            case 2:
                _t->resize((*reinterpret_cast<QSize(*)>(_a[1])));
                break;
            case 3:
                _t->updateRequestNewTile((*reinterpret_cast<int(*)>(_a[1])),
...
QT_INIT_METAOBJECT const QMetaObject
    qmapcontrol::LayerManager::staticMetaObject = {
        {&QObject::staticMetaObject,
         qt_meta_stringdata_qmapcontrol__LayerManager.data,
         qt_meta_data_qmapcontrol__LayerManager, qt_static_metacall, nullptr,
         nullptr}};
...
void* qmapcontrol::LayerManager::qt_metacast(const char* _clname)
{
    if (!_clname)
        return nullptr;
    if (!strcmp(_clname,
                qt_meta_stringdata_qmapcontrol__LayerManager.stringdata0))
        return static_cast<void*>(this);
    return QObject::qt_metacast(_clname);
}

int qmapcontrol::LayerManager::qt_metacall(QMetaObject::Call _c, int _id,
                                           void** _a)
{
