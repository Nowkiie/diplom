...
#include "../../submodules/BaseMap/adapters/tilemapadapter.h"
...
#define QT_MOC_LITERAL(idx, ofs, len)                                       \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(                \
        len,                                                                \
        qptrdiff(offsetof(qt_meta_stringdata_qmapcontrol__TileMapAdapter_t, \
                          stringdata0)                                      \
                 + ofs - idx * sizeof(QByteArrayData)))
static const qt_meta_stringdata_qmapcontrol__TileMapAdapter_t
    qt_meta_stringdata_qmapcontrol__TileMapAdapter = {
        {
...
void qmapcontrol::TileMapAdapter::qt_static_metacall(QObject* _o,
                                                     QMetaObject::Call _c,
                                                     int _id, void** _a)
{
    Q_UNUSED(_o);
...
QT_INIT_METAOBJECT const QMetaObject
    qmapcontrol::TileMapAdapter::staticMetaObject = {
        {&MapAdapter::staticMetaObject,
         qt_meta_stringdata_qmapcontrol__TileMapAdapter.data,
         qt_meta_data_qmapcontrol__TileMapAdapter, qt_static_metacall, nullptr,
         nullptr}};
...
void* qmapcontrol::TileMapAdapter::qt_metacast(const char* _clname)
{
    if (!_clname)
        return nullptr;
    if (!strcmp(_clname,
                qt_meta_stringdata_qmapcontrol__TileMapAdapter.stringdata0))
        return static_cast<void*>(this);
    return MapAdapter::qt_metacast(_clname);
}

int qmapcontrol::TileMapAdapter::qt_metacall(QMetaObject::Call _c, int _id,
                                             void** _a)
{
