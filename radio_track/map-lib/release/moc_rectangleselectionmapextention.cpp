...
#    error \
        "The header file 'rectangleselectionmapextention.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len)                                         \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(                  \
        ...
        qptrdiff(                                                             \
            offsetof(                                                         \
                qt_meta_stringdata_qmapcontrol__RectangleSelectionGeometry_t, \
                stringdata0)                                                  \
            + ofs - idx * sizeof(QByteArrayData)))
static const qt_meta_stringdata_qmapcontrol__RectangleSelectionGeometry_t
    qt_meta_stringdata_qmapcontrol__RectangleSelectionGeometry = {
        {
...
void qmapcontrol::RectangleSelectionGeometry::qt_static_metacall(
...
QT_INIT_METAOBJECT const QMetaObject
    qmapcontrol::RectangleSelectionGeometry::staticMetaObject = {
...
int qmapcontrol::RectangleSelectionGeometry::qt_metacall(QMetaObject::Call _c,
                                                         int _id, void** _a)
{
...
#define QT_MOC_LITERAL(idx, ofs, len)                                             \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(                      \
        ...
        qptrdiff(                                                                 \
            offsetof(                                                             \
                qt_meta_stringdata_qmapcontrol__RectangleSelectionMapExtention_t, \
                stringdata0)                                                      \
            + ofs - idx * sizeof(QByteArrayData)))
static const qt_meta_stringdata_qmapcontrol__RectangleSelectionMapExtention_t
    qt_meta_stringdata_qmapcontrol__RectangleSelectionMapExtention = {
        {
...
void qmapcontrol::RectangleSelectionMapExtention::qt_static_metacall(
    QObject* _o, QMetaObject::Call _c, int _id, void** _a)
{
...
QT_INIT_METAOBJECT const QMetaObject
    qmapcontrol::RectangleSelectionMapExtention::staticMetaObject = {
...
const QMetaObject* qmapcontrol::RectangleSelectionMapExtention::metaObject()
    const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject()
                                      : &staticMetaObject;
...
void* qmapcontrol::RectangleSelectionMapExtention::qt_metacast(
    const char* _clname)
{
    if (!_clname)
        return nullptr;
...
int qmapcontrol::RectangleSelectionMapExtention::qt_metacall(
