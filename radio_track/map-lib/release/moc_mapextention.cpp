...
#define QT_MOC_LITERAL(idx, ofs, len)                                          \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(                   \
        len, qptrdiff(offsetof(qt_meta_stringdata_qmapcontrol__MapExtention_t, \
                               stringdata0)                                    \
                      + ofs - idx * sizeof(QByteArrayData)))
static const qt_meta_stringdata_qmapcontrol__MapExtention_t
    qt_meta_stringdata_qmapcontrol__MapExtention = {
        {
...
static const uint qt_meta_data_qmapcontrol__MapExtention[] = {
    ...
    1, 1, 34, 2, 0x06 /* Public */, 5, 1, 37, 2, 0x06 /* Public */,

    // slots: name, argc, parameters, tag, flags
    6, 0, 40, 2, 0x0a /* Public */, 7, 1, 41, 2, 0x0a /* Public */,

    // signals: parameters
    QMetaType::Void, 0x80000000 | 3, 4, QMetaType::Void, 0x80000000 | 3, 4,

    // slots: parameters
    QMetaType::Void, QMetaType::Void, 0x80000000 | 3, 4,

    0  // eod
};

void qmapcontrol::MapExtention::qt_static_metacall(QObject* _o,
                                                   QMetaObject::Call _c,
                                                   int _id, void** _a)
{
    if (_c == QMetaObject::InvokeMetaMethod)
    {
        ...
        {
            case 0:
                _t->started((*reinterpret_cast<MapExtention*(*)>(_a[1])));
                break;
            case 1:
                _t->done((*reinterpret_cast<MapExtention*(*)>(_a[1])));
                break;
            case 2:
                _t->start();
                break;
    ...
    else if (_c == QMetaObject::IndexOfMethod)
    {
        int* result = reinterpret_cast<int*>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t*>(_a[1])
                == static_cast<_t>(&MapExtention::started))
            {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MapExtention::*)(MapExtention*);
            if (*reinterpret_cast<_t*>(_a[1])
                == static_cast<_t>(&MapExtention::done))
            {
                *result = 1;
                return;
            }
...
QT_INIT_METAOBJECT const QMetaObject
    qmapcontrol::MapExtention::staticMetaObject = {
        {&QObject::staticMetaObject,
         ...
         qt_meta_data_qmapcontrol__MapExtention, qt_static_metacall, nullptr,
         nullptr}};
...
void* qmapcontrol::MapExtention::qt_metacast(const char* _clname)
{
    if (!_clname)
        return nullptr;
    if (!strcmp(_clname,
                qt_meta_stringdata_qmapcontrol__MapExtention.stringdata0))
        return static_cast<void*>(this);
    return QObject::qt_metacast(_clname);
}

int qmapcontrol::MapExtention::qt_metacall(QMetaObject::Call _c, int _id,
                                           void** _a)
{
