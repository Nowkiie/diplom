...
#define QT_MOC_LITERAL(idx, ofs, len)                                       \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(                \
        len, qptrdiff(offsetof(qt_meta_stringdata_qmapcontrol__MapLoader_t, \
                               stringdata0)                                 \
                      + ofs - idx * sizeof(QByteArrayData)))
static const qt_meta_stringdata_qmapcontrol__MapLoader_t
    qt_meta_stringdata_qmapcontrol__MapLoader = {
        {
...
static const uint qt_meta_data_qmapcontrol__MapLoader[] = {
    ...
    1, 4, 29, 2, 0x06 /* Public */, 7, 3, 38, 2, 0x06 /* Public */, 8, 0, 45, 2,
    0x06 /* Public */,
    ...
    QMetaType::Int, 4, 5, 6, QMetaType::Void,

    0  // eod
};

void qmapcontrol::MapLoader::qt_static_metacall(QObject* _o,
    ...
    else if (_c == QMetaObject::IndexOfMethod)
    {
        int* result = reinterpret_cast<int*>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t*>(_a[1])
                == static_cast<_t>(&MapLoader::imageLoaded))
            {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t*>(_a[1])
                == static_cast<_t>(&MapLoader::imageEmpty))
            {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t*>(_a[1])
                == static_cast<_t>(&MapLoader::imageLoadingComplited))
            {
                *result = 2;
                return;
            }
...
QT_INIT_METAOBJECT const QMetaObject qmapcontrol::MapLoader::staticMetaObject =
    {{&QObject::staticMetaObject,
      ...
      qt_meta_data_qmapcontrol__MapLoader, qt_static_metacall, nullptr,
      nullptr}};
...
int qmapcontrol::MapLoader::qt_metacall(QMetaObject::Call _c, int _id,
                                        void** _a)
{
...
// SIGNAL 0
void qmapcontrol::MapLoader::imageLoaded(const QPixmap _t1, int _t2, int _t3,
                                         int _t4)
{
    void* _a[] = {nullptr,
