...
#    error \
        "The header file 'cursorposmapextention.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len)                                         \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(                  \
        len,                                                                  \
        qptrdiff(                                                             \
            offsetof(qt_meta_stringdata_qmapcontrol__CursorPosMapExtention_t, \
                     stringdata0)                                             \
            + ofs - idx * sizeof(QByteArrayData)))
static const qt_meta_stringdata_qmapcontrol__CursorPosMapExtention_t
    qt_meta_stringdata_qmapcontrol__CursorPosMapExtention = {
        {
...
static const uint qt_meta_data_qmapcontrol__CursorPosMapExtention[] = {
    ...
    1, 1, 29, 2, 0x06 /* Public */, 1, 1, 32, 2, 0x06 /* Public */,

    // slots: name, argc, parameters, tag, flags
    4, 2, 35, 2, 0x08 /* Private */,

    // signals: parameters
    QMetaType::Void, QMetaType::QPointF, 3, QMetaType::Void, QMetaType::QString,
    3,
...
void qmapcontrol::CursorPosMapExtention::qt_static_metacall(
    QObject* _o, QMetaObject::Call _c, int _id, void** _a)
{
    if (_c == QMetaObject::InvokeMetaMethod)
    {
        ...
        {
            case 0:
                _t->cursorPos((*reinterpret_cast<QPointF(*)>(_a[1])));
                break;
            case 1:
                _t->cursorPos((*reinterpret_cast<QString(*)>(_a[1])));
                break;
            case 2:
                _t->mouseEventCoordinate_(
    ...
    else if (_c == QMetaObject::IndexOfMethod)
    {
        int* result = reinterpret_cast<int*>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t*>(_a[1])
                == static_cast<_t>(&CursorPosMapExtention::cursorPos))
            {
                *result = 0;
                return;
            }
...
QT_INIT_METAOBJECT const QMetaObject
    qmapcontrol::CursorPosMapExtention::staticMetaObject = {
        {&PersistentMapExtention::staticMetaObject,
         qt_meta_stringdata_qmapcontrol__CursorPosMapExtention.data,
         qt_meta_data_qmapcontrol__CursorPosMapExtention, qt_static_metacall,
         nullptr, nullptr}};
...
void* qmapcontrol::CursorPosMapExtention::qt_metacast(const char* _clname)
{
    ...
    if (!strcmp(
            _clname,
            qt_meta_stringdata_qmapcontrol__CursorPosMapExtention.stringdata0))
        return static_cast<void*>(this);
    return PersistentMapExtention::qt_metacast(_clname);
}

int qmapcontrol::CursorPosMapExtention::qt_metacall(QMetaObject::Call _c,
                                                    int _id, void** _a)
{
