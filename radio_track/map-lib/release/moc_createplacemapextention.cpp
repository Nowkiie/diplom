...
#    error \
        "The header file 'createplacemapextention.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len)                                      \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(               \
        ...
        qptrdiff(                                                          \
            offsetof(                                                      \
                qt_meta_stringdata_qmapcontrol__CreatePlaceMapExtention_t, \
                stringdata0)                                               \
            + ofs - idx * sizeof(QByteArrayData)))
static const qt_meta_stringdata_qmapcontrol__CreatePlaceMapExtention_t
    qt_meta_stringdata_qmapcontrol__CreatePlaceMapExtention = {
        {
...
static const uint qt_meta_data_qmapcontrol__CreatePlaceMapExtention[] = {
    ...
    QMetaType::QColor, 7, QMetaType::Void, QMetaType::Int, 9, QMetaType::Void,
    0x80000000 | 11, QMetaType::QPointF, 12, 13, QMetaType::Void,
    0x80000000 | 11, QMetaType::QPointF, 12, 13, QMetaType::Void,
    0x80000000 | 11, QMetaType::QPointF, 12, 13,

    0  // eod
};

void qmapcontrol::CreatePlaceMapExtention::qt_static_metacall(
    ...
    if (_c == QMetaObject::InvokeMetaMethod)
    {
        ...
        switch (_id)
        {
            ...
            case 2:
                ...
                break;
            case 3:
                _t->setRadius((*reinterpret_cast<int(*)>(_a[1])));
                break;
            case 4:
...
QT_INIT_METAOBJECT const QMetaObject
    qmapcontrol::CreatePlaceMapExtention::staticMetaObject = {
        {&qmapcontrol::GeometryCreatorMapExtention::staticMetaObject,
         qt_meta_stringdata_qmapcontrol__CreatePlaceMapExtention.data,
         qt_meta_data_qmapcontrol__CreatePlaceMapExtention, qt_static_metacall,
         nullptr, nullptr}};
...
void* qmapcontrol::CreatePlaceMapExtention::qt_metacast(const char* _clname)
{
    if (!_clname)
        return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_qmapcontrol__CreatePlaceMapExtention
                             .stringdata0))
        return static_cast<void*>(this);
    return qmapcontrol::GeometryCreatorMapExtention::qt_metacast(_clname);
}

int qmapcontrol::CreatePlaceMapExtention::qt_metacall(QMetaObject::Call _c,
                                                      int _id, void** _a)
{
