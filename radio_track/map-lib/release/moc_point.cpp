...
#include "../../submodules/BaseMap/geometries/point.h"
...
#define QT_MOC_LITERAL(idx, ofs, len)                                   \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(            \
        len, qptrdiff(offsetof(qt_meta_stringdata_qmapcontrol__Point_t, \
                               stringdata0)                             \
                      + ofs - idx * sizeof(QByteArrayData)))
static const qt_meta_stringdata_qmapcontrol__Point_t
    qt_meta_stringdata_qmapcontrol__Point = {
        {
...
static const uint qt_meta_data_qmapcontrol__Point[] = {
    ...
    1, 1, 24, 2, 0x0a /* Public */, 4, 1, 27, 2, 0x0a /* Public */,

    // slots: parameters
    QMetaType::Void, QMetaType::QPointF, 3, QMetaType::Void, QMetaType::Bool, 5,

    0  // eod
};

void qmapcontrol::Point::qt_static_metacall(QObject* _o, QMetaObject::Call _c,
                                            int _id, void** _a)
{
    if (_c == QMetaObject::InvokeMetaMethod)
    {
        ...
        {
            case 0:
                _t->setCoordinate((*reinterpret_cast<QPointF(*)>(_a[1])));
                break;
            case 1:
...
QT_INIT_METAOBJECT const QMetaObject qmapcontrol::Point::staticMetaObject = {
    {&Geometry::staticMetaObject, qt_meta_stringdata_qmapcontrol__Point.data,
     qt_meta_data_qmapcontrol__Point, qt_static_metacall, nullptr, nullptr}};
