...
#error "The header file 'geometrycreatormapextention.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_qmapcontrol__GeometryCreatorMapExtention_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_qmapcontrol__GeometryCreatorMapExtention_t qt_meta_stringdata_qmapcontrol__GeometryCreatorMapExtention = {
    {
...
void qmapcontrol::GeometryCreatorMapExtention::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<GeometryCreatorMapExtention *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->objectCreated((*reinterpret_cast< GeometryCreatorMapExtention*(*)>(_a[1])),(*reinterpret_cast< Geometry*(*)>(_a[2]))); break;
        ...
        case 0:
            ...
            case 0:
                *reinterpret_cast<int*>(_a[0]) = qRegisterMetaType< GeometryCreatorMapExtention* >(); break;
            }
            break;
        case 2:
            switch (*reinterpret_cast<int*>(_a[1])) {
        ...
        {
            using _t = void (GeometryCreatorMapExtention::*)(GeometryCreatorMapExtention * , Geometry * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GeometryCreatorMapExtention::objectCreated)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject qmapcontrol::GeometryCreatorMapExtention::staticMetaObject = { {
...
void *qmapcontrol::GeometryCreatorMapExtention::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_qmapcontrol__GeometryCreatorMapExtention.stringdata0))
        return static_cast<void*>(this);
    return CheckableMapExtention::qt_metacast(_clname);
}

int qmapcontrol::GeometryCreatorMapExtention::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
...
// SIGNAL 0
void qmapcontrol::GeometryCreatorMapExtention::objectCreated(GeometryCreatorMapExtention * _t1, Geometry * _t2)
{
