...
#error "The header file 'checkablemapextention.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_qmapcontrol__CheckableMapExtention_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_qmapcontrol__CheckableMapExtention_t qt_meta_stringdata_qmapcontrol__CheckableMapExtention = {
    {
...
void qmapcontrol::CheckableMapExtention::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->keyboardEvent_((*reinterpret_cast< const QKeyEvent*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CheckableMapExtention::checkedChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject qmapcontrol::CheckableMapExtention::staticMetaObject = { {
    &MapExtention::staticMetaObject,
    qt_meta_stringdata_qmapcontrol__CheckableMapExtention.data,
    qt_meta_data_qmapcontrol__CheckableMapExtention,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *qmapcontrol::CheckableMapExtention::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_qmapcontrol__CheckableMapExtention.stringdata0))
        return static_cast<void*>(this);
    return MapExtention::qt_metacast(_clname);
}

int qmapcontrol::CheckableMapExtention::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
