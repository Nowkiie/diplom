...
#error "The header file 'geometryinfomapextention.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_GeometryInfoMapExtention_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_GeometryInfoMapExtention_t qt_meta_stringdata_GeometryInfoMapExtention = {
    {
...
void GeometryInfoMapExtention::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->mouseDoubleClickEvent_((*reinterpret_cast< QMouseEvent*(*)>(_a[1])),(*reinterpret_cast< QPointF(*)>(_a[2]))); break;
        default: ;
        }
...
QT_INIT_METAOBJECT const QMetaObject GeometryInfoMapExtention::staticMetaObject = { {
    &qmapcontrol::MapExtention::staticMetaObject,
    qt_meta_stringdata_GeometryInfoMapExtention.data,
    qt_meta_data_GeometryInfoMapExtention,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *GeometryInfoMapExtention::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_GeometryInfoMapExtention.stringdata0))
...
int GeometryInfoMapExtention::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
