...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_qmapcontrol__MapNetworkFactory_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_qmapcontrol__MapNetworkFactory_t qt_meta_stringdata_qmapcontrol__MapNetworkFactory = {
    {
...
void qmapcontrol::MapNetworkFactory::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MapNetworkFactory::mapConnected)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject qmapcontrol::MapNetworkFactory::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_qmapcontrol__MapNetworkFactory.data,
    qt_meta_data_qmapcontrol__MapNetworkFactory,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *qmapcontrol::MapNetworkFactory::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_qmapcontrol__MapNetworkFactory.stringdata0))
        return static_cast<void*>(this);
    return QObject::qt_metacast(_clname);
}

int qmapcontrol::MapNetworkFactory::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
...
// SIGNAL 0
void qmapcontrol::MapNetworkFactory::mapConnected(QString _t1, QString _t2, int _t3)
{
