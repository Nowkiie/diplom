...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_paramNet_t, stringdata0) + ofs \
...
void paramNet::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<paramNet *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->updateVectorAntSystem((*reinterpret_cast< QVector<antSystem>(*)>(_a[1]))); break;
        case 1: _t->updateVectorSender((*reinterpret_cast< QVector<structParamNet::sender>(*)>(_a[1]))); break;
        case 2: _t->updateVectorRecvier((*reinterpret_cast< QVector<recvier>(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&paramNet::updateVectorAntSystem)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&paramNet::updateVectorSender)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&paramNet::updateVectorRecvier)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject paramNet::staticMetaObject = { {
    ...
    qt_meta_stringdata_paramNet.data,
    qt_meta_data_paramNet,
    qt_static_metacall,
    nullptr,
    nullptr
} };
