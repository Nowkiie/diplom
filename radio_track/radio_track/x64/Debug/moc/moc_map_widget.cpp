...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_track__MapWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_track__MapWidget_t qt_meta_stringdata_track__MapWidget = {
    {
...
static const uint qt_meta_data_track__MapWidget[] = {
 ...
 // slots: parameters
    QMetaType::Void, QMetaType::QPixmap, QMetaType::Int, QMetaType::Int,   10,   11,   12,

       0        // eod
};

void track::MapWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<MapWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->MouseDoubleClickEvent((*reinterpret_cast< QMouseEvent*(*)>(_a[1])),(*reinterpret_cast< QPointF(*)>(_a[2]))); break;
        case 1: _t->loadingFinished(); break;
        case 2: _t->MouseMoveEvent((*reinterpret_cast< const QMouseEvent*(*)>(_a[1])),(*reinterpret_cast< const QPointF(*)>(_a[2]))); break;
        case 3: _t->tile_get((*reinterpret_cast< const QPixmap(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MapWidget::MouseDoubleClickEvent)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MapWidget::loadingFinished)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MapWidget::MouseMoveEvent)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject track::MapWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_track__MapWidget.data,
    qt_meta_data_track__MapWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
