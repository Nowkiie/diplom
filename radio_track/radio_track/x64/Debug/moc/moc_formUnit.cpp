...
void unitWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->unitCreated((*reinterpret_cast< unit(*)>(_a[1]))); break;
        case 1: _t->unitUpdate((*reinterpret_cast< unit(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&unitWindow::unitCreated)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (unitWindow::*)(unit );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&unitWindow::unitUpdate)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject unitWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_unitWindow.data,
    qt_meta_data_unitWindow,
    qt_static_metacall,
    nullptr,
    nullptr
} };
