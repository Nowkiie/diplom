...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_qmapcontrol__Layer_req_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_qmapcontrol__Layer_req_t qt_meta_stringdata_qmapcontrol__Layer_req = {
    {
...
void qmapcontrol::Layer_req::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Layer_req::tile_load)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject qmapcontrol::Layer_req::staticMetaObject = { {
    ...
    qt_meta_stringdata_qmapcontrol__Layer_req.data,
    qt_meta_data_qmapcontrol__Layer_req,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
int qmapcontrol::Layer_req::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
