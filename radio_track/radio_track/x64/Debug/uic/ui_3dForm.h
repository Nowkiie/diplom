...
public:
    ...
    void setupUi(QWidget *Form)
    {
        ...
        radioButtonDecart->setObjectName(QString::fromUtf8("radioButtonDecart"));
        radioButtonDecart->setGeometry(QRect(10, 50, 82, 17));

        verticalLayout_2->addWidget(groupTypeCoord);

        verticalSpacer = new QSpacerItem(109, 48, QSizePolicy::Minimum, QSizePolicy::Expanding);
    ...
    void retranslateUi(QWidget *Form)
    {
        ...
        groupHeights->setTitle(QApplication::translate("Form", "Height range", nullptr));
        label_min->setText(QApplication::translate("Form", "min", nullptr));
        label_max->setText(QApplication::translate("Form", "max", nullptr));
        groupTypeCoord->setTitle(QApplication::translate("Form", "Type coordinate", nullptr));
        radioButtonGeo->setText(QApplication::translate("Form", "Geo", nullptr));
        radioButtonDecart->setText(QApplication::translate("Form", "Decart", nullptr));
    } // retranslateUi
