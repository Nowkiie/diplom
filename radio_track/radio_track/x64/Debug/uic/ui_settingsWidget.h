...
public:
    ...
    void setupUi(QWidget *setForm)
    {
        ...
        frameInfo->setStyleSheet(QString::fromUtf8("background-color: rgba(255,0,0,20)"));
        ...
        btn4CloseInfo->setStyleSheet(QString::fromUtf8("background-color:rgba(0,0,0,0)"));
        ...
        textInfo->setStyleSheet(QString::fromUtf8("background-color:rgba(0,0,0,0)"));
    ...
    void retranslateUi(QWidget *setForm)
    {
        ...
        buttonApply->setText(QApplication::translate("setForm", "Apply", nullptr));
        btn4CloseInfo->setText(QApplication::translate("setForm", "x", nullptr));
#ifndef QT_NO_TOOLTIP
        tabWidget->setToolTip(QApplication::translate("setForm", "<html><head/><body><p><br/></p></body></html>", nullptr));
#endif // QT_NO_TOOLTIP
        ...
        tabWidget->setTabText(tabWidget->indexOf(unit), QApplication::translate("setForm", "Unit", nullptr));
        group_antSystem->setTitle(QApplication::translate("setForm", "ant system", nullptr));
        btn_addAntSystem->setText(QApplication::translate("setForm", "+", nullptr));
        btn_delAntSystem->setText(QApplication::translate("setForm", "-", nullptr));
        btn_changeAntSystem->setText(QApplication::translate("setForm", "!", nullptr));
        group_sender->setTitle(QApplication::translate("setForm", "sender", nullptr));
        btn_addSender->setText(QApplication::translate("setForm", "+", nullptr));
        btn_delSender->setText(QApplication::translate("setForm", "-", nullptr));
        btn_changeSender->setText(QApplication::translate("setForm", "!", nullptr));
        group_recvier->setTitle(QApplication::translate("setForm", "recvier", nullptr));
        btn_addRec->setText(QApplication::translate("setForm", "+", nullptr));
        btn_delRec->setText(QApplication::translate("setForm", "-", nullptr));
        btn_changeRec->setText(QApplication::translate("setForm", "!", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(hardware), QApplication::translate("setForm", "hardware", nullptr));
    } // retranslateUi
