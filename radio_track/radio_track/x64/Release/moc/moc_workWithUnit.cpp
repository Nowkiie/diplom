...
#define QT_MOC_LITERAL(idx, ofs, len)                                       \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(                \
        len, qptrdiff(offsetof(qt_meta_stringdata_settings__workWithUnit_t, \
                               stringdata0)                                 \
                      + ofs - idx * sizeof(QByteArrayData)))
static const qt_meta_stringdata_settings__workWithUnit_t
    qt_meta_stringdata_settings__workWithUnit = {
        {
...
static const uint qt_meta_data_settings__workWithUnit[] = {
    ...
    1, 0, 24, 2, 0x06 /* Public */, 3, 0, 25, 2, 0x06 /* Public */,
...
void settings::workWithUnit::qt_static_metacall(QObject* _o,
    ...
    else if (_c == QMetaObject::IndexOfMethod)
    {
        int* result = reinterpret_cast<int*>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t*>(_a[1])
                == static_cast<_t>(&workWithUnit::unitCreated))
            {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (workWithUnit::*)();
            if (*reinterpret_cast<_t*>(_a[1])
                == static_cast<_t>(&workWithUnit::unitWindowClosed))
            {
                *result = 1;
                return;
            }
...
QT_INIT_METAOBJECT const QMetaObject settings::workWithUnit::staticMetaObject =
    {{&QWidget::staticMetaObject,
      ...
      qt_meta_data_settings__workWithUnit, qt_static_metacall, nullptr,
      nullptr}};
...
int settings::workWithUnit::qt_metacall(QMetaObject::Call _c, int _id,
                                        void** _a)
{
