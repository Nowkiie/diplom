...
public:
    ...
    void setupUi(QMainWindow* radio_trackClass)
    {
        if (radio_trackClass->objectName().isEmpty())
            radio_trackClass->setObjectName(
                QString::fromUtf8("radio_trackClass"));
    ...
    {
        radio_trackClass->setWindowTitle(QApplication::translate(
            "radio_trackClass", "radio_track", nullptr));
    }  // retranslateUi
};
