...
public:
    ...
    void setupUi(QWidget* unitForm)
    {
        ...
        lineEdit_degree_2->setObjectName(
            QString::fromUtf8("lineEdit_degree_2"));
        ...
        lineEdit_arcsec_2->setObjectName(
            QString::fromUtf8("lineEdit_arcsec_2"));
        ...
        hardware_groupBox->setObjectName(
            QString::fromUtf8("hardware_groupBox"));
    ...
    {
        unitForm->setWindowTitle(
            QApplication::translate("unitForm", "Unit Form", nullptr));
        nameLabel->setText(
            QApplication::translate("unitForm", "Name unit", nullptr));
        send_groupBox->setTitle(
            QApplication::translate("unitForm", "Coordinate", nullptr));
        lineEdit_degree->setInputMask(
            QApplication::translate("unitForm", "000", nullptr));
        lineEdit_sec->setInputMask(
            QApplication::translate("unitForm", "00", nullptr));
        lineEdit_arcsec->setInputMask(
            QApplication::translate("unitForm", "00", nullptr));
        name_lat->setText(QApplication::translate("unitForm", "N", nullptr));
        label_lat_send->setText(
            QApplication::translate("unitForm", "Latitude:", nullptr));
        label_degree->setText(QString());
        label_sec->setText(QString());
        label_arcsec->setText(QString());
        label_lon_send->setText(
            QApplication::translate("unitForm", "Longitude:", nullptr));
        lineEdit_degree_2->setInputMask(
            QApplication::translate("unitForm", "000", nullptr));
        label_degree_2->setText(QString());
        lineEdit_sec_2->setInputMask(
            QApplication::translate("unitForm", "00", nullptr));
        label_sec_2->setText(QString());
        lineEdit_arcsec_2->setInputMask(
            QApplication::translate("unitForm", "00", nullptr));
        label_arcsec_2->setText(QString());
        name_lon->setText(QApplication::translate("unitForm", "E", nullptr));
        hardware_groupBox->setTitle(
            QApplication::translate("unitForm", "Hardware", nullptr));
        group_antSystem->setTitle(
            QApplication::translate("unitForm", "ant system", nullptr));
        btn_addAntSystem->setText(
            QApplication::translate("unitForm", "+", nullptr));
        btn_delAntSystem->setText(
            QApplication::translate("unitForm", "-", nullptr));
        btn_changeAntSystem->setText(
            QApplication::translate("unitForm", "!", nullptr));
        group_sender->setTitle(
            QApplication::translate("unitForm", "sender", nullptr));
        ...
        group_recvier->setTitle(
            QApplication::translate("unitForm", "recvier", nullptr));
        ...
        btn_changeRec->setText(
            QApplication::translate("unitForm", "!", nullptr));
        btnApply->setText(
            QApplication::translate("unitForm", "Apply", nullptr));
    }  // retranslateUi
};
