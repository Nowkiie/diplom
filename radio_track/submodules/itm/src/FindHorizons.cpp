...
void FindHorizons(std::vector<double>& pfl, double a_e__meter, double h__meter[2], double theta_hzn[2], double d_hzn__meter[2])
{
    int np = int(pfl[0]);
    double xi = pfl[1];
    ...
    double z_rx__meter = pfl[np + 1] + h__meter[1]; //BUG!!! //pfl[np + 2]
