...
DLLEXPORT double ComputeDeltaH(std::vector<double>& pfl, double d_start__meter, double d_end__meter);
...
DLLEXPORT void FindHorizons(std::vector<double>& pfl, double a_e__meter, double h__meter[2], double theta_hzn[2], double d_hzn__meter[2]);
...
DLLEXPORT void InitializePointToPoint(double f__mhz, double h_sys__meter, double N_0, int pol, double epsilon, 
...
DLLEXPORT void LinearLeastSquaresFit(std::vector<double> &pfl, double d_start, double d_end, double *fit_y1, double *fit_y2);
