...
void PrintWarningMessages(FILE* fp, long warnings)
{
    ...
    else
    {
        if (warnings & WARN__TX_TERMINAL_HEIGHT)
            PrintWarningHelper(fp, LBL__WARN_TX_TERMINAL_HEIGHT);
        if (warnings & WARN__RX_TERMINAL_HEIGHT)
            PrintWarningHelper(fp, LBL__WARN_RX_TERMINAL_HEIGHT);
        if (warnings & WARN__FREQUENCY)
            PrintWarningHelper(fp, LBL__WARN_FREQUENCY);
        if (warnings & WARN__PATH_DISTANCE_TOO_BIG_1)
            PrintWarningHelper(fp, LBL__WARN_PATH_DISTANCE_TOO_BIG_1);
        if (warnings & WARN__PATH_DISTANCE_TOO_BIG_2)
            PrintWarningHelper(fp, LBL__WARN_PATH_DISTANCE_TOO_BIG_2);
        if (warnings & WARN__PATH_DISTANCE_TOO_SMALL_1)
            PrintWarningHelper(fp, LBL__WARN_PATH_DISTANCE_TOO_SMALL_1);
        if (warnings & WARN__PATH_DISTANCE_TOO_SMALL_2)
            PrintWarningHelper(fp, LBL__WARN_PATH_DISTANCE_TOO_SMALL_2);
        if (warnings & WARN__TX_HORIZON_ANGLE)
            PrintWarningHelper(fp, LBL__WARN_TX_HORIZON_ANGLE);
        if (warnings & WARN__RX_HORIZON_ANGLE)
            PrintWarningHelper(fp, LBL__WARN_RX_HORIZON_ANGLE);
        if (warnings & WARN__TX_HORIZON_DISTANCE_1)
            PrintWarningHelper(fp, LBL__WARN_TX_HORIZON_DISTANCE_1);
        if (warnings & WARN__RX_HORIZON_DISTANCE_1)
            PrintWarningHelper(fp, LBL__WARN_RX_HORIZON_DISTANCE_1);
        if (warnings & WARN__TX_HORIZON_DISTANCE_2)
            PrintWarningHelper(fp, LBL__WARN_TX_HORIZON_DISTANCE_2);
        if (warnings & WARN__RX_HORIZON_DISTANCE_2)
            PrintWarningHelper(fp, LBL__WARN_RX_HORIZON_DISTANCE_2);
        if (warnings & WARN__EXTREME_VARIABILITIES)
            PrintWarningHelper(fp, LBL__WARN_EXTREME_VARIABILITIES);
        if (warnings & WARN__SURFACE_REFRACTIVITY)
            PrintWarningHelper(fp, LBL__WARN_SURFACE_REFRACTIVITY);
    }
}
