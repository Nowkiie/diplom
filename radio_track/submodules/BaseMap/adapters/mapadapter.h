...
namespace qmapcontrol
{
    ...
    public:
        ...
        //! возвращаем дистанцию в единицах измерения конвертера в виде текста
        /*!
         * @возвращаем дистанцию в единицах измерения конвертера в виде текста
         */
        QString distanceToText(double kilometers) const;
    ...
    protected:
        ...
        virtual void fromQuery(QString query, int &x, int &y, int &z) const = 0;
