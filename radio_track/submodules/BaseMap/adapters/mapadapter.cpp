...
namespace qmapcontrol
{
    ...
    void MapAdapter::applyDistanceConverter(IDistanceConverterPtr distanceConverter)
    {
        distanceConverter_ = distanceConverter;
    }

    QString MapAdapter::distanceToText(double kilometers) const
    {
        const double units = distanceConverter_->fromKilometers(kilometers);
        return distanceConverter_->toText(units, true);
    }
}
