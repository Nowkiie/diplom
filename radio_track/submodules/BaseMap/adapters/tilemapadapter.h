...
namespace qmapcontrol
{
    ...
    class TileMapAdapter : public MapAdapter
    {
         ...
         * TileMapAdapter* ta = new TileMapAdapter("192.168.8.1", 256, 0,17);<br/>
         ...
         */
        TileMapAdapter(const QString& host, int tilesize, int minZoom = 0, int maxZoom = 17);
    ...
    protected:
        ...
        virtual void fromQuery(QString query, int &x, int &y, int &z) const;
