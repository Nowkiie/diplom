...
BOOST_AUTO_TEST_SUITE(ArythmeticsAbstractSub)
...
std::string res1 = "178\xC2\xB0 18' 18'' 221'''";
std::string res2 = "133\xC2\xB0 33' 32'' 445'''";
...
{
    BOOST_CHECK_EQUAL((x1 - x2).to_string(show_milliseconds), "-" + res2);
}
BOOST_AUTO_TEST_CASE(test_arythm_sub_degree_02)
{
    BOOST_CHECK_EQUAL((x1 - x3).to_string(show_milliseconds), "-" + res1);
}
BOOST_AUTO_TEST_CASE(test_arythm_sub_degree_03)
{
    BOOST_CHECK_EQUAL((x1 - x4).to_string(show_milliseconds), "-" + res3);
}
BOOST_AUTO_TEST_CASE(test_arythm_sub_degree_04)
{
    BOOST_CHECK_EQUAL((x2 - x4).to_string(show_milliseconds), "-" + res1);
}
BOOST_AUTO_TEST_CASE(test_arythm_sub_degree_05)
{
    BOOST_CHECK_EQUAL((x3 - x4).to_string(show_milliseconds), "-" + res2);
}
BOOST_AUTO_TEST_CASE(test_arythm_sub_degree_06)
{
    BOOST_CHECK_EQUAL((x3 - x2).to_string(show_milliseconds), res4);
}
BOOST_AUTO_TEST_CASE(test_arythm_sub_degree_07)
{
    BOOST_CHECK_EQUAL((x3 - x1).to_string(show_milliseconds), res1);
}
BOOST_AUTO_TEST_CASE(test_arythm_sub_degree_08)
{
    BOOST_CHECK_EQUAL((x4 - x2).to_string(show_milliseconds), res1);
}
BOOST_AUTO_TEST_CASE(test_arythm_sub_degree_09)
{
    BOOST_CHECK_EQUAL((x2 - x1).to_string(show_milliseconds), res2);
}
BOOST_AUTO_TEST_CASE(test_arythm_sub_degree_10)
{
    BOOST_CHECK_EQUAL((x2 - x3).to_string(show_milliseconds), "-" + res4);
}
BOOST_AUTO_TEST_CASE(test_arythm_sub_degree_11)
{
    BOOST_CHECK_EQUAL((x4 - x1).to_string(show_milliseconds), res3);
}
BOOST_AUTO_TEST_CASE(test_arythm_sub_degree_12)
{
    BOOST_CHECK_EQUAL((x4 - x3).to_string(show_milliseconds), res2);
}
