...
BOOST_AUTO_TEST_SUITE(ArythmeticsLatitudeDiv)
...
{
    BOOST_CHECK_EQUAL((x1 / 2).to_string(show_milliseconds), res1 + " ю.ш.");
}
BOOST_AUTO_TEST_CASE(test_arythm_div_degree_02)
{
    BOOST_CHECK_EQUAL((x1 / 0.5).to_string(show_milliseconds), res2 + " ю.ш.");
}
BOOST_AUTO_TEST_CASE(test_arythm_div_degree_03)
{
    BOOST_CHECK_EQUAL((x2 / 2).to_string(show_milliseconds), res3 + " ю.ш.");
}
BOOST_AUTO_TEST_CASE(test_arythm_div_degree_04)
{
    BOOST_CHECK_EQUAL((x2 / 0.5).to_string(show_milliseconds), res4 + " ю.ш.");
}
BOOST_AUTO_TEST_CASE(test_arythm_div_degree_05)
{
    BOOST_CHECK_EQUAL((x4 / 2).to_string(show_milliseconds), res1 + " с.ш.");
}
BOOST_AUTO_TEST_CASE(test_arythm_div_degree_06)
{
    BOOST_CHECK_EQUAL((x4 / 0.5).to_string(show_milliseconds), res2 + " с.ш.");
}
BOOST_AUTO_TEST_CASE(test_arythm_div_degree_07)
{
    BOOST_CHECK_EQUAL((x3 / 2).to_string(show_milliseconds), res3 + " с.ш.");
}
BOOST_AUTO_TEST_CASE(test_arythm_div_degree_08)
{
    BOOST_CHECK_EQUAL((x3 / 0.5).to_string(show_milliseconds), res4 + " с.ш.");
}
...
{
    BOOST_CHECK_EQUAL((x4 / 8).to_string(show_milliseconds), res6 + " с.ш.");
}
BOOST_AUTO_TEST_CASE(test_arythm_div_degree_14)
{
    BOOST_CHECK_EQUAL((x1 / 8).to_string(show_milliseconds), res6 + " ю.ш.");
}
