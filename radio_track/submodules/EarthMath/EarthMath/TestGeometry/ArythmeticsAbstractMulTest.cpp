...
BOOST_AUTO_TEST_SUITE(ArythmeticsAbstractMul)
...
{
    BOOST_CHECK_EQUAL((x1 * 0.5).to_string(show_milliseconds), "-" + res2);
}
BOOST_AUTO_TEST_CASE(test_arythm_mul_degree_02)
{
    BOOST_CHECK_EQUAL((x1 * 2).to_string(show_milliseconds), "-" + res3);
}
BOOST_AUTO_TEST_CASE(test_arythm_mul_degree_03)
{
    BOOST_CHECK_EQUAL((x2 * 0.5).to_string(show_milliseconds), "-" + res1);
}
BOOST_AUTO_TEST_CASE(test_arythm_mul_degree_04)
{
    BOOST_CHECK_EQUAL((x2 * 2).to_string(show_milliseconds), "-" + res4);
}
...
{
    BOOST_CHECK_EQUAL((x4 * 0.5).to_string(show_milliseconds), res2);
}
BOOST_AUTO_TEST_CASE(test_arythm_mul_degree_07)
{
    BOOST_CHECK_EQUAL((x4 * 2).to_string(show_milliseconds), res3);
}
BOOST_AUTO_TEST_CASE(test_arythm_mul_degree_08)
{
    BOOST_CHECK_EQUAL((x3 * 0.5).to_string(show_milliseconds), res1);
}
BOOST_AUTO_TEST_CASE(test_arythm_mul_degree_09)
{
    BOOST_CHECK_EQUAL((x3 * 2).to_string(show_milliseconds), res4);
}
...
{
    BOOST_CHECK_EQUAL((x4 * 8).to_string(show_milliseconds), res5);
}
BOOST_AUTO_TEST_CASE(test_arythm_mul_degree_12)
{
    BOOST_CHECK_EQUAL((x1 * 8).to_string(show_milliseconds), "-" + res5);
}
BOOST_AUTO_TEST_CASE(test_arythm_mul_degree_13)
{
    BOOST_CHECK_EQUAL((x4 * 0.125).to_string(show_milliseconds), res6);
}
BOOST_AUTO_TEST_CASE(test_arythm_mul_degree_14)
{
    BOOST_CHECK_EQUAL((x1 * 0.125).to_string(show_milliseconds), "-" + res6);
}
